...
# Installig tools
pacman -S --noconfirm xdg-user-dirs xdg-utils pipewire pipewire-pulse pipewire-alsa easyeffects udiskie udisks2 xarchiver pcmanfm \
gvfs gvfs-smb gvfs-afc ntfs-3g bash bash-completion rsync rclone flatpak terminus-font
